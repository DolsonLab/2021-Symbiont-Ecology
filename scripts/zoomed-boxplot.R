...
initial_data <- read.table("munged_mult_sym_100.dat", h=T)
...
vert5 <- cbind(subset(final_data, treatment== 0.05), Treatment= "5%")
vert6 <- cbind(subset(final_data, treatment== 0.06), Treatment= "6%")
vert7 <- cbind(subset(final_data, treatment== 0.07), Treatment= "7%")
vert8 <- cbind(subset(final_data, treatment== 0.08), Treatment= "8%")
vert9 <- cbind(subset(final_data, treatment== 0.09), Treatment= "9%")
vert10 <- cbind(subset(final_data, treatment== 0.10), Treatment= "9%")
...
final_vert <- rbind(vert5,vert6,vert7,vert8,vert9,vert10)
